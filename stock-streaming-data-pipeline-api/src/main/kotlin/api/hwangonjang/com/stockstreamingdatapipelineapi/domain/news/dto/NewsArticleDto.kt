...
data class NewsArticleDto(
    ...
    val newsStocks: List<NewsStockSimpleDto>? = null
) {
    companion object {
        fun from(entity: NewsArticle): NewsArticleDto {
            return NewsArticleDto(
                ...
                newsStocks = entity.newsStocks.map { NewsStockSimpleDto.from(it) }
            )
        }
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is NewsArticleDto) return false
